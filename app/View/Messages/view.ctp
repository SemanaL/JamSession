...
<div id='nav'>
<a id='previous'  href='<?php echo $this->Html->url(array('controller' => 'messages', 'action' => 'navigate'))."/-1/".$content['id'];?>'>PREC</a>
<a id='next' href='<?php echo $this->Html->url(array('controller' => 'messages', 'action' => 'navigate'))."/1/".$content['id'];?>'>SUIV</a>
</div>
</br>
